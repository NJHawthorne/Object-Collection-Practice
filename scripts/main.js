...
//Just setting up a forEach function for future use. Should make life easier. Probably won't.
...
function accumulatePrices(storeList) {
  ...
  //Establishing that I only want USD prices
  if(storeList.currency_code === 'USD'){
    //Adding them all up...
    average += storeList.price;
...
iterate(items, accumulatePrices);
